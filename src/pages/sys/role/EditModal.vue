    ...
    <div id="j_modal" class="portlet light bordered modal fade" tabindex="-1" data-width="800">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">新增|编辑角色</span>
            </div>
            <div class="tools">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" autocomplete="off" placeholder="角色名称" name="roleName" v-model="formObj.roleName" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-11">
                        ...
                        <div class="col-md-11">
                            <div class="form-group">
                                <label class="col-md-3 control-label"><span class="required">*</span>角色状态</label>
                                <div class="col-md-9">
        ...
        methods: {
            ...
            onSubmit: function(event) {
                ...
                if (self.editForm.valid()) {
                    $.ajax({
                        url: self.isAdd ? '/api/rbac/addRole' : '/api/rbac/updateRole',
                        type: 'POST',
                        data: self.formObj
                    }).done(resp => {
                        if(resp.code == '0000'){
