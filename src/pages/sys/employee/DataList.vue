        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <form action="#" class="form-horizontal">
                            <div class="row ">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="control-label col-md-5">账号状态:</label>
                                        <div class="col-md-7">
                    ...
                    <a v-show="checkPermissions(['addEmployee'])" @click="onAddEditForm($event)" class="btn green-meadow" href="javascript:;"><i class="fa fa-plus-square"></i> 新增</a>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer">
                            ...
                            <tbody>
                                <tr v-for="(obj,idx) in dataList">
                                    <td>{{obj.eid}}</td>
                                    <td>{{$root.departmentMap[obj.did] || '无'}}</td>
                                    <td>{{obj.account}}</td>
                                    <td>{{obj.ename}}</td>
                                    <td>{{obj.phone}}</td>
                                    <td>{{obj.email || '无'}}</td>
                                    <td>
                                        <span class="btn btn-xs" :class="obj.level==100 ? 'purple' : 'blue' ">
                                            {{obj.level==100 ? '管理员' : '普通账号'}}
                                        </span>   
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a v-show="checkPermissions(['updateEmployee'])" @click="onAddEditForm($event,obj)" class="btn btn-xs purple" href="javascript:;"><i class="fa fa-edit"></i> 编辑</a>
                                    </td>
                                </tr>                                
                            </tbody>
                        </table>
    ...
    export default {
        ...
        computed: {
            pagerConfig: function() {
                return {
                    url: '/api/rbac/getEmployeeByPage',
