...
var vm = new Vue({
    ...
    created: function() {
        ...
        let departmentSelect = basicData.getDepartmentSelect();
        this.departmentList = departmentSelect.list;
        this.departmentMap = departmentSelect.map;
    },
