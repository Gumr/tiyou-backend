          ...
          <div class="table-toolbar">
            <form action="#" class="form-horizontal">
              <div class="row flex_group">
                ...
                <!-- 电话号码 -->
                <div class="form-group flex_content">
                  <label class="control-label lable_title_name">电话号码:</label>
                  <div class="">
                    <input type="text" class="form-control" autocomplete="off" placeholder="请输入电话号码搜索" v-model="searchParam.phone" @keyup.enter="onSearch($event)">
                  </div>
                </div>
              </div>
              <!-- 清空/搜索 -->
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer">
              ...
              <tbody>
                <tr v-for="(obj,idx) in dataList">
                  ...
                  <td class="text-center">
                    <a v-show="checkPermissions(['updateUserLcoin'])"  @click="onLcoinControlForm($event,obj)" class="btn btn-xs blue" href="javascript:;">
                      <i class="fa fa-edit"></i> 增减课时
                    </a>
...
export default {
  ...
  methods: {
    ...
    // 打开增减课时表单的Modal弹窗
    onLcoinControlForm: function (event, obj) {
      event.preventDefault();
      this.$root.$emit('openLcoinControlModal', obj == null ? {} : obj);
    },
